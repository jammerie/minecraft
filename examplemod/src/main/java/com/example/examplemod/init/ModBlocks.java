...
import com.example.examplemod.block.BeaconOreBlock;
...
public final class ModBlocks {
	...
	public static final RegistryObject<Block> EXAMPLE_ORE = BLOCKS.register(
			"example_ore",
			() -> new Block(
					Block.Properties
	...
	// This block has the ROCK material, meaning it needs at least a wooden pickaxe to break it. It is very similar to Iron Ore
	public static final RegistryObject<Block> BEACON_ORE = BLOCKS.register(
			"beacon_ore",
			() -> new BeaconOreBlock(
					Block.Properties
							.create(Material.ROCK)
